...
| **Health** | "weight 88kg", "8000 steps", "2000 calories", "120g protein", "did 45 min strength training", "today's workout", "finished my workout", "skip today's workout", "today's plan", "how was my week", *[meal photo]* | log metric/ad-hoc workout, today's metrics, fetch/complete/skip today's structured workout (fuzzy-free — always operates on the single active workout), AI daily plan, AI weekly report, meal-photo calorie/protein estimate |
